...
$pdf->Cell(60,10,'Tex Tricks',0,1,'C');

$pdf->Line(10,18,72,18);
$pdf->Line(10,19,72,19);

$pdf->SetFont('Arial','',8);
$pdf->Cell(60,3,'plot no. 3 third floor pravesh nagar,',0,1,'C');

$pdf->SetFont('Arial','',8);
$pdf->Cell(63,3,'shastripura, road, Paschim Puri, Agra',0,1,'C');

$pdf->SetFont('Arial','',8);
$pdf->Cell(63,4,'Agra, Uttar Pradesh 282007',0,1,'C');
...
$pdf->Cell(75,4 ,'Tex tricks',0,1,'L');
